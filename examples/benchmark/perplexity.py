...
if __name__ == "__main__":
    ...
    ppl = ppl.calculate(args.n_ctx, args.n_batch)
    
    # The Perplexity class calculates PPL cumulatively. The last element is the final corpus PPL.
    avg_ppl = ppl[-1]
    print(f"Perplexity: {avg_ppl}")
